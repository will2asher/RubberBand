...
EFFECT(CREATE_ARROWS,				false,	NULL,		0,		EFINFO_NONE,	"uses a staff to create a stack of ordinary arrows")
EFFECT(MAGIC_ARROWS,				false,	NULL,		0,		EFINFO_NONE,	"uses a staff to create a stack of good arrows (depending on the staff)")
