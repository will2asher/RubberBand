...
EFFECT(GAIN_LUCK, false, NULL, 1, EFINFO_CONST, "grants %d luck", "")
EFFECT(SLIME_CHANCE, false, NULL, 1, EFINFO_CONST, "has %d chance to slime you", "")
EFFECT(HEAL_SLIME, false, NULL, 1, EFINFO_CONST, "cures %d points of slime", "")
EFFECT(HERBALC, false, NULL, 0, EFINFO_CONST, "has a chance of curing frenzy, amnesia, disease, and sliming, depending on your level", "")
EFFECT(MEDIOC, false, NULL, 0, EFINFO_CONST, "raises low stats and damages high stats, among other things", "")
...
EFFECT(GRENADE, false, "dam", 3, EFINFO_BALL, "creates a ball of %s with radius %d, dealing %s damage at the centre", "strike with %s")
