...
static struct
{
	...
	{ L"M",        "Hydras" },
	{ L"i",        "Dark Fairies or Icky Things (depending on VISH option)" },
	{ L"FI",       "Insects" },
	{ L"j",        "Jellies and Slimes" },
	{ L"K",        "Knights and other higher-level humanoids" },
	{ L"k",        "Kobolds" },
	{ L"L",        "Lichs" },
	{ L"tp",       "Men" },
	{ L".$!?=~_:", "Mimics" },
	{ L"m",        "Ainur/maia" },
	{ L",",        "Mushroom Patches and molds" },
	{ L"n",        "Nagas" },
	{ L"N",        "Nulx and other tentacled horrors" },
	{ L"o",        "Orcs" },
	{ L"q",        "Quadrupeds" },
	{ L"Q",        "Quylthulgs" },
	{ L"R",        "Reptiles" },
	...
	{ L"s",        "Skeletons/Drujs" },
	{ L"J",        "Snakes" },
	{ L"^",        "Trap monsters (or traps)" },
	{ L"l",        "Trees/Ents" },
	{ L"T",        "Trolls" },
	{ L"V",        "Vampires and Ghouls" },
	{ L"W",        "Wights/Wraiths" },
	{ L"w",        "Worms/Worm Masses" },
	{ L"X",        "Xorns and other elemental monsters" },
	{ L"y",        "Light Fairies or Yeeks (depending on VISH option)" },
	{ L"Y",        "Yeti and Apes" },
	{ L"Z",        "Zephyr Hounds" },
	{ L"z",        "Zombies" },
	{ NULL,       NULL }
