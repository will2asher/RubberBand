...
TMD(BHELD,      PR_STATUS,						PU_BONUS)
TMD(CONFUSED,	PR_STATUS,						PU_BONUS)
TMD(FRENZY,     PR_STATUS,						PU_BONUS)
TMD(AFRAID,		PR_STATUS,						PU_BONUS)
TMD(CHARMED,    PR_STATUS,						PU_BONUS)
TMD(INSANE,     PR_STATUS,						PU_BONUS)
TMD(DISEASE,    PR_STATUS,						PU_BONUS)
TMD(PCCURSED,   PR_STATUS,						PU_BONUS)
...
TMD(TSIGHT,     PR_STATUS,						PU_BONUS | PU_MONSTERS)
...
TMD(TELEPATHY,	PR_STATUS,						PU_BONUS | PU_MONSTERS)
...
TMD(PHAZED,		PR_STATUS,						PU_BONUS)
TMD(SDRUNK,		PR_STATUS,						PU_BONUS)
TMD(XBLOW,		PR_STATUS,						PU_BONUS)
TMD(CLEAR_MIND, PR_STATUS,						PU_BONUS)
TMD(SPELLCRFT,	PR_STATUS,						PU_BONUS)
TMD(ZAPPING,	PR_STATUS,						PU_BONUS)
TMD(ATT_COLDIRON, PR_STATUS,					PU_BONUS)
TMD(ATT_SILVER, PR_STATUS,						PU_BONUS)
TMD(LYCANT,		PR_STATUS,						PU_BONUS)
TMD(2NDTHOT,	PR_STATUS,						PU_BONUS | PU_MONSTERS)
TMD(TREASMAP,	PR_STATUS,						PU_BONUS)
TMD(ACHARM,		PR_STATUS,						PU_BONUS)
TMD(PETRIFIED,	PR_STATUS,						PU_BONUS)
TMD(DARKVIS,	PR_MAP,							PU_UPDATE_VIEW | PU_MONSTERS)
TMD(TORCHLIGHT, PR_MAP | PR_STATUS,				PU_UPDATE_VIEW | PU_MONSTERS)
