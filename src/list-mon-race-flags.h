...
RF(SEASONAL,	RFT_GEN,		"")
RF(RUBBER,		RFT_GEN,		"")
RF(TOWN_OR_DUN, RFT_GEN,        "")
RF(SILLY,       RFT_GEN,        "")
RF(SCALE,		RFT_GEN,		"")
RF(UNAWARE,		RFT_NOTE,		"")
RF(MULTIPLY,	RFT_NOTE,		"")
RF(SMULTIPLY,	RFT_NOTE,		"")
...
RF(BR_STRONG,	RFT_BEHAV,		"")
RF(BLOCK_LOS,	RFT_BEHAV,		"")
RF(KEEP_DIST,	RFT_BEHAV,		"")
RF(MOVE_SLOW,	RFT_BEHAV,		"")
RF(ROAM,		RFT_BEHAV,		"")
RF(RETURNS,		RFT_BEHAV,		"")
RF(GOODMON,		RFT_BEHAV,		"")
RF(NONAGR,		RFT_BEHAV,		"")
RF(WATER_HIDE,	RFT_BEHAV,		"")
RF(WATER_ONLY,  RFT_BEHAV,      "")
RF(FLY,			RFT_BEHAV,		"")
...
RF(PUDDLE,		RFT_ALTER,		"leaves puddles in its wake")
RF(FEY,			RFT_RACE_N,		"fairy")
