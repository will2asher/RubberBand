...
RSF(RGAZE,		RST_BOLT | RST_INNATE)
RSF(THROW,      RST_BOLT | RST_INNATE)
...
RSF(BR_AMNS,    RST_BREATH | RST_INNATE)
RSF(BR_FEAR,    RST_BREATH | RST_INNATE)
RSF(BR_SLIME,   RST_BREATH | RST_INNATE)
...
RSF(BLIND,		RST_ANNOY)
RSF(CONF,		RST_ANNOY)
RSF(INSANITY,   RST_ANNOY)
RSF(DISEASE,    RST_ANNOY)
RSF(CURSE_PC,	RST_ANNOY)
